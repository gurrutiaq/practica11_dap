<%@ Page Title="Home Page" Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="WebApplication8._Default" %>
...
Preferences"></asp:Label>
 ...
 <br />
 <asp:CheckBox ID="lenovo" runat="server" Text="lenovo" OnCheckedChanged="lenovo_CheckedChanged" />
 <br />
